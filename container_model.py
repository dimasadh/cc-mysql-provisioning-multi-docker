...
class PhpmyadminProvisioning:
    def __init__(self):
        ...
        self.mesin = dict()
        self.mesin['mesin1']='tcp://192.168.99.100:2376'
        self.mesin['mesin2']='tcp://192.168.99.101:2376'
        self.mesin['mesin3']='tcp://192.168.99.102:2376'

        # self.tls_config = docker.tls.TLSConfig(
        #     ca_cert='C:/Users/asus/.docker/machine/certs/ca.pem',
        #     client_cert=('C:/Users/asus/.docker/machine/certs/cert.pem',
        #                  'C:/Users/asus/.docker/machine/certs/key.pem'),
        #     verify=True
        # )
    ...
    def get(self,username='royyana'):
        try:
            ...
            info = dict(username=self.username,
                        ...
                        ip_machine = self.userdb[f"{self.username}_ip_machine"],
    ...
    def create(self,username='royyana'):
        ...
        try:
            ...
            self.userdb[f"{self.username}_ip_machine"] = self.mesin[self.mesin_terpilih]
